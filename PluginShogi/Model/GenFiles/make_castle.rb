...
#
class Castle
  attr_accessor :name, :id, :image, :piece_list, :base_list
  ...
  def initialize(node)
    ...
    if node["image"] != nil and File.extname(node["image"]) == ""
...
# ボイスのあるパス
base_path = "..\\..\\ShogiData\\Effect\\Other\\CastleEffect\\Voice"
